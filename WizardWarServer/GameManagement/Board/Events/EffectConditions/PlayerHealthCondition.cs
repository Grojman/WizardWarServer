...
{
    public PlayerHealthCondition(bool me, NumberFilter value)
    {
        Me = me;
        Value = value;
    }
    ...
    public override bool Check(Guid playerId, Guid rivalId, CardInstance sourceCard, GameState state, GameEvent? ev)
    {
        ...
        return Value.Compare(player.Health);
    }

    public override EffectCondition Clone() => new PlayerHealthCondition(Me, Value);
}